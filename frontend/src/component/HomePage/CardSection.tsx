    ...
    <div className="max-w-7xl mx-auto p-8 grid grid-cols-1 lg:grid-cols-3 gap-8 select-none">
      ...
      <div className="lg:col-span-2 bg-[#171717] rounded-3xl p-10 border border-orange-900/60 relative overflow-hidden group transition-all duration-500 hover:border-orange-700/80 hover:shadow-2xl hover:shadow-orange-900/20 hover:-translate-y-2">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            ...
            <h2 className="text-white text-2xl font-semibold group-hover:text-orange-100 transition-colors duration-300">
          ...
          <p className="text-gray-400 text-md mb-8 leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
            Transform long URLs into clean, memorable links in seconds. Simplify
            sharing and enhance your brand with our fast and reliable shortening
            engine.
          </p>
          ...
          <div className="space-y-1 cursor-none">
            <div className="flex items-center gap-4 group/item hover:translate-x-2 transition-transform duration-200">
              ...
              <span className="text-gray-300 text-base group-hover/item:text-white transition-colors duration-200">
                Fast redirection
              </span>
            </div>
      ...
      <div className="bg-[#171717] rounded-3xl p-8 border border-orange-900/60 relative overflow-hidden group transition-all duration-500 hover:border-orange-700/80 hover:shadow-2xl hover:shadow-orange-900/20 hover:-translate-y-2">
        ...
        <div className="absolute bottom-6 right-6 flex items-end gap-1 opacity-0 group-hover:opacity-60 transition-opacity duration-500">
          ...
          <div
            className="w-1 bg-orange-500 rounded-full animate-pulse"
            style={{ height: "20px", animationDelay: "200ms" }}
          ></div>
          <div
            className="w-1 bg-orange-500 rounded-full animate-pulse"
            style={{ height: "16px", animationDelay: "400ms" }}
          ></div>
          <div
            className="w-1 bg-orange-500 rounded-full animate-pulse"
            style={{ height: "24px", animationDelay: "600ms" }}
          ></div>
        </div>
      </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-6">
            <div className="w-10 h-10 bg-orange-800/30 rounded-lg flex items-center justify-center group-hover:bg-orange-700/40 group-hover:scale-110 group-hover:rotate-12 transition-all duration-300">
              ...
              >
                ...
                />
                <path
                  d="M8.5 8.5L14 6L11.5 11.5L6 14L8.5 8.5Z"
                  stroke="white"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <p className="text-gray-400 text-sm leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
            ...
            <span className="text-orange-400/80">
              Use password protected links to give authorized access.
            </span>
          </p>
        </div>
      ...
      <div className="bg-[#171717] rounded-3xl p-8 border border-orange-900/60 relative overflow-hidden group transition-all duration-500 hover:border-orange-700/80 hover:shadow-2xl hover:shadow-orange-900/20 hover:-translate-y-2">
        ...
        <div className="relative z-10">
          ...
          <p className="text-gray-400 text-base mb-8 leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
            Fully open source project made with{" "}
            <Heart className="inline w-5 h-5 text-red-500 mx-1 group-hover:text-red-400 group-hover:scale-110 transition-all duration-300" />{" "}
            by kurama
          </p>
        </div>
      ...
      <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-white text-lg font-semibold group-hover:text-orange-100 transition-colors duration-300">
                  Fast Redirection
                </h3>
              </div>
              ...
              <div className="relative w-12 h-8 bg-orange-900/20 rounded border border-orange-800/40 overflow-hidden group-hover:border-orange-600/60 transition-colors duration-300">
                <div className="absolute inset-0 flex items-center justify-center text-xs font-bold text-white transition-opacity duration-300">
                  <div className="country-slider transition-transform duration-500 ease-in-out">
                    <span className="country-flag text-sm">
            ...
            <p className="text-gray-400 text-sm leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
              Lightning-fast redirects from anywhere in the world.
              <br />
              <span className="text-orange-400/80">
                Global CDN ensures minimal latency worldwide.
              </span>
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-8 h-8 bg-orange-800/30 rounded-lg flex items-center justify-center group-hover:bg-orange-700/40 group-hover:scale-110 transition-all duration-300">
                ...
                >
                  <path
                    d="M8 2V1M8 15V14M15 8H14M2 8H1M12.3638 3.63623L11.6567 4.34334M4.34315 11.6569L3.63604 12.364M12.3638 12.364L11.6567 11.6569M4.34315 4.34334L3.63604 3.63623"
                    stroke="white"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  />
              ...
              <h3
                className={`text-lg font-semibold transition-all duration-500 ${show404 ? "text-red-400" : "text-white group-hover:text-orange-100"}`}
              >
            ...
            <div
              className={`transition-all duration-500 ${show404 ? "opacity-0 translate-y-2" : "opacity-100 translate-y-0"}`}
            >
              <p className="text-gray-400 text-sm leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
                URL that will expire after Clicks | Hours or maybe just a hover
                :)
                <br />
                <span className="text-orange-400/80">
                  Set custom expiration dates for your links.
                </span>
              </p>
            </div>
            ...
            {/* 404 Content */}
            <div
              className={`absolute inset-6 flex flex-col justify-center items-center transition-all duration-500 ${show404 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
              <div className="text-red-400 text-2xl font-bold mb-1 animate-pulse">
                404
              </div>
          ...
          {/* Timer animation */}
          <div
            className={`absolute top-3 right-3 w-2 h-2 rounded-full transition-all duration-300 ${show404 ? "bg-red-500 opacity-100" : "bg-yellow-500 opacity-0 group-hover:opacity-100"}`}
          >
            <div
              className={`w-full h-full rounded-full animate-ping ${show404 ? "bg-red-500/50" : "bg-yellow-500/50"}`}
            ></div>
          </div>
        </div>
      </div>
