      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-6">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-black/50 backdrop-blur-xl rounded-2xl mb-6 shadow-2xl border border-white/10">
          ...
          <div className="relative backdrop-blur-2xl rounded-2xl shadow-2xl border border-white/10 p-8"
            ...
            <div className="relative z-10 space-y-6">
              ...
              >
                {isPending ? (
                  <>
                    <div className="w-5 h-5 border-2 border-gray-400 border-t-indigo-400 rounded-full animate-spin" />
                    <span>Verifying...</span>
                  </>
                ) : (
                  <>
