  ...
  return (
    <Card className="bg-zinc-900 border-zinc-800">
      <CardHeader>
        ...
        <CardDescription className="text-zinc-400">Manage and track your shortened URLs</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {paginatedUrls.map((url) => (
                <tr key={url.id} className="border-b border-zinc-800 hover:bg-zinc-800/30">
                  <td className="p-2">
                    <div className="flex items-center gap-2">
                      <code className="text-orange-400 bg-zinc-800 px-2 py-1 rounded text-xs">{url.shortUrl}</code>
                      <Button
                        size="sm"
                        variant="ghost"
                  ...
                  <td className="p-2 max-w-xs">
                    <div className="truncate text-zinc-300" title={url.destination}>
                      {url.destination}
                    </div>
                  </td>
